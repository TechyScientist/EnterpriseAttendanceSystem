...
<script>
    window.history.replaceState(null, "", "${pageContext.request.contextPath}/deregister.jsp");
</script>
...
<form action="DeregisterStudentServlet" method="post" style="display: grid; grid-template-rows: auto auto; grid-template-columns: auto auto; grid-template-areas: 'course student' 'submit submit'; gap: 10px;">
    ...
    <button type="submit" id="deregister-submit" name="deregister-submit" style="grid-area: submit; justify-self: center;">Submit Deregistration Request <img src="assets/img/proceed.png" alt="Proceed"/></button>
</form>
